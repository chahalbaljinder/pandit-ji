      ...
      <form onSubmit={handleSubmit}>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <input
                  ...
                  className={`block w-full rounded-md shadow-sm ${
                    errors.password ? 'border-red-300 focus:border-red-500 focus:ring-red-500' : 'border-gray-300 focus:border-orange-500 focus:ring-orange-500'
                  }`}
        ...
        <div className="mt-8 flex justify-between">
          ...
          {currentStep < 4 ? (
            ...
            <button
              type="submit"
              disabled={isLoading || registerMutation.isPending || createPanditProfileMutation.isPending}
              className="px-6 py-2 bg-orange-600 text-white rounded-md hover:bg-orange-700 flex items-center"
            >
              {isLoading || registerMutation.isPending || createPanditProfileMutation.isPending ? (
                <>
